...
module.exports = function(grunt) {
    ...
    require('time-grunt')(grunt); //show task duration

    var modRewrite = require('connect-modrewrite'); //allow clean URLs in html5 (pushState):


    require('jit-grunt')(grunt, { //loads tasks on demand, not all tasks on every watch. Reduced compile time with 95%
    ...
    grunt.initConfig({
        //pkg: grunt.file.readJSON("xyz.json"), //TODO: add file for project config, variables
        connect: {
            main: {
                options: {
                    port: 9001,
